...
определим характер зависимостей \( u_2(u1) \), определяемых каждым из уравнений.

Начнём с трансцендентных:
\[
    \left[
        \begin{array}{l}
            \frac{\mu_1\tg u_1 (a-c)}{u_1} + \frac{\mu_2\tg u_2 c}{u_2} = 0,\\
...
\[
    \left[
        \begin{array}{l}
            -\frac{\mu_1\tg u_1 (a-c)}{u_1^2} +
            \frac{\mu_1(a-c)}{u_1\cos^2u_1(a-c)}
            - \frac{\mu_2\tg u_2 c}{u_2^2}u_2' +
            \frac{\mu_2c}{u_1\cos^2u_2 c}u_2' = 0,\\
            \frac{\tg u_1 (a-c)}{\eps_1} + \frac{u_1(a-c)}{\eps_1\cos^2u_1(a-c)}
            + \frac{u_2'\tg u_2 c}{\eps_2} + \frac{u_2cu_2'}{\eps_2\cos^2u_2c}
            = 0.
        \end{array}
    \right.
\]
\[
    \left[
        \begin{array}{l}
            u_2' = -\frac{\mu_1\cos^2u_2c}{\mu_2\cos^2u_1(a-c)}
            \frac{2u_1(a-c) - \sin 2 u_1(a-c)}{2u_2 c - \sin 2 u_2 c},\\
            u_2' = -\frac{\eps_2\cos^2u_2c}{\eps_1\cos^2u_1(a-c)}
            \frac{2u_1(a-c) + \sin 2 u_1(a-c)}{2u_2 c + \sin 2 u_2 c}.\\
        \end{array}
    \right.
\]
...
уравнений зависимость \( u_2(u_1) \) -- убывающая. В то же время функция
