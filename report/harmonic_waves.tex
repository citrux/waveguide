...
\[
    \frac{\mu_1\tg u_1 (a-c)}{u_1} + \frac{\mu_2\tg u_2 c}{u_2} = 0,
\]
совпадающее с первым уравнением системы (\ref{sys:relations}).

\subsubsection{LE-волны}
Теперь используя первое уравнение системы (\ref{sys:relations})
\[
    \frac{\mu_1\tg u_1 (a-c)}{u_1} + \frac{\mu_2\tg u_2 c}{u_2} = 0,
\]
...
Аналогично
\[
    E_2 = H_2\frac{\mu_2\omega\pi n}{u_2hb}.
\]
...
\[
    ...
    \right.
\]
Эти волны не имеют одной из поперечных электрических компонент, поэтому называются
продольно-электрическими (LE).

\subsubsection{LM-волны}
А в случае
\[
    \frac{u_1\tg u_1 (a-c)}{\eps_1} + \frac{u_2\tg u_2 c}{\eps_2} = 0,
\]
...
\[
    ...
    \right.
\]
Эти волны не имеют одной из поперечных магнитных компонент, поэтому называются
продольно-магнитными (LM).
