...
if __name__ == '__main__':
    plot_transversal_field(e_relation, 0, 1, 7e10)
    plot_transversal_field(e_relation, 0, 2, 7e10)
    plot_transversal_field(e_relation, 0, 3, 7e10)
    plot_transversal_field(e_relation, 1, 1, 7e10)
    plot_transversal_field(e_relation, 1, 2, 7e10)
    plot_transversal_field(m_relation, 1, 0, 8e10)
    plot_transversal_field(m_relation, 1, 1, 8e10)
    plot_transversal_field(m_relation, 1, 2, 8e10)
    plot_transversal_field(m_relation, 1, 3, 8e10)
    plot_transversal_field(m_relation, 2, 0, 8e10)
